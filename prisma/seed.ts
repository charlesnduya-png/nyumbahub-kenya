...
export async function main() {
  ...
  const amenities = await Promise.all(
    [
      { name: "Parking", icon: "car", category: "Security & parking" },
      { name: "Swimming pool", icon: "swimming-pool", category: "Outdoor" },
      { name: "24/7 security", icon: "security-24-7", category: "Security & parking" },
      { name: "Backup generator", icon: "backup-generator", category: "Utilities" },
      { name: "Fibre internet", icon: "fibre-internet", category: "Utilities" },
      { name: "Private gym", icon: "private-gym", category: "Interior & lifestyle" },
      { name: "Borehole / own water", icon: "borehole", category: "Utilities" },
      { name: "Garden", icon: "garden", category: "Outdoor" },
      { name: "Furnished", icon: "furnished", category: "Interior & lifestyle" },
      { name: "CCTV", icon: "cctv", category: "Security & parking" },
      { name: "Family / TV room", icon: "family-tv-room", category: "Interior & lifestyle" },
      { name: "Home office / study", icon: "home-office-study", category: "Interior & lifestyle" },
      { name: "Fireplace", icon: "fireplace", category: "Interior & lifestyle" },
      { name: "Balcony", icon: "balcony", category: "Interior & lifestyle" },
      { name: "Laundry room", icon: "laundry-room", category: "Interior & lifestyle" },
      { name: "Guest house", icon: "guest-house", category: "Interior & lifestyle" },
      { name: "Garage", icon: "garage", category: "Security & parking" },
      { name: "Covered parking", icon: "covered-parking", category: "Security & parking" },
      { name: "Ample parking", icon: "ample-parking", category: "Security & parking" },
      { name: "UN / embassy approved", icon: "un-embassy-approved", category: "Premium location" },
      { name: "Diplomatic area", icon: "diplomatic-area", category: "Premium location" },
      { name: "Near international school", icon: "near-international-school", category: "Premium location" },
      { name: "Near shopping centres", icon: "near-shopping-centres", category: "Premium location" },
